...
$ scripts/rebaseline_compare_maps.py

For documentation, type:

$ scripts/rebaseline_compare_maps.py -h
"""
...
def main() -> None:
    ...
    log_txt: str = full_path(
        [rebaseline_dir], [map_label, "log", str(iterations)], "txt"
    )
    ...
    best_plan_csv: str = full_path(
        [rebaseline_dir], [best_plan_name, "vtd", "assignments"]
    )
    ...
    candidates_csv: str = path_to_file([rebaseline_dir]) + file_name(
